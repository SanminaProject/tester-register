...
- [`ListTesterRequest.php`](app/Http/Requests/Api/ListTesterRequest.php)
    - 字段验证: page, per_page, status, customer_id (exists), search
    - 确保: 列表过滤参数合法且分页参数范围受控
...
| 控制器                                                                                      | 修改方法                            | 使用的验证类                                                                                  |
| ------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------- |
| [TesterController](app/Http/Controllers/Api/TesterController.php)                           | `index()`                           | ListTesterRequest                                                                             |
