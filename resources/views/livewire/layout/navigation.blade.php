...
<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-12 sm:h-16 relative">
            
            <!-- Mobile Page Title -->
            <div class="absolute inset-0 flex justify-center items-center pointer-events-none sm:hidden">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-primary hover:bg-thirdly/40 focus:outline-none focus:bg-thirdly/40 focus:text-primary transition duration-150 ease-in-out">
